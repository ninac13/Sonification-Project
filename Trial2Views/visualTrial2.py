...
def index():
    ...
    if request.method == "POST":
        ...
        if time_taken and markers_used and mutations_found is not None:
            ...
            records = {rec.id: str(rec.seq) for rec in SeqIO.parse(SET2_FASTA, "fasta")}
            ...
            with open(TRIAL_RESULTS_FILE, "a", newline="") as f:
                ...
                writer.writerow([participant, 2, time_taken, markers_used, mutations_found, misplaced])

            return redirect(url_for("visual_trial3.index", participant=participant))
...
<body>
  <div class="container">
    <h1>Trial 2 Visual DNA Sequences</h1>
  </div><br />                                
  <div class="container">
    ...
    <ul class="instructions">
      ...
      <li>The visual trial 2 will be in the same format as the previous activity.</li>
